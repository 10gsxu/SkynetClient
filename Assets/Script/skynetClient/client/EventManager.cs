...
namespace Skynet.DotNetClient
{
    ...
    {
        private Dictionary<int, Action<SpObject>> callBackMap;
        private Dictionary<string, List<Action<SpObject>>> eventMap;

        public EventManager()
        {
            this.callBackMap = new Dictionary<int, Action<SpObject>>();
            this.eventMap = new Dictionary<string, List<Action<SpObject>>>();
        }
        ...
        public void InvokeOnEvent(string route, SpObject msg)
        {
            ...
            List<Action<SpObject>> list = eventMap[route];
